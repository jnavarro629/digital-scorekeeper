...
export const GameTimer = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      {/* Timer Display */}
      <div className="bg-card border-2 border-border rounded-lg px-6 py-3 shadow-lg">
        <div className="font-digital text-5xl md:text-6xl tracking-wider text-foreground">
